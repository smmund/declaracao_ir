...
def exibir_conteudo_mensal():
    ...
    if add_slider == 1:
        st.title(f"Mês selecionado - JANEIRO/{ano_base}")
        ...
        st.title(f"Mês selecionado - FEVEREIRO/{ano_base}")
        ...
        st.title(f"Mês selecionado - MARÇO/{ano_base}")
        ...
        st.title(f"Mês selecionado - ABRIL/{ano_base}")
        ...
        st.title(f"Mês selecionado - MAIO/{ano_base}")
        ...
        st.title(f"Mês selecionado - JUNHO/{ano_base}")
        ...
        st.title(f"Mês selecionado - JULHO/{ano_base}")
        ...
        st.title(f"Mês selecionado - AGOSTO/{ano_base}")
        ...
        st.title(f"Mês selecionado - SETEMBRO/{ano_base}")
        ...
        st.title(f"Mês selecionado - OUTUBRO/{ano_base}")
        ...
        st.title(f"Mês selecionado - NOVEMBRO/{ano_base}")
        ...
        st.title(f"Mês selecionado - DEZEMBRO/{ano_base}")
...
if st.session_state["authentication_status"]:
    ...
    st.warning('Por favor, insira nome de usuário e senha')
